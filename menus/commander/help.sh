...
menu_manage_commander_help ()
{
    ...
    text_white "    lets you configure the directory core is installed into when you select Install KAPU Core (you can change this before you start the core installation)."
    echo
    ...
    text_white "    lets you configure a different custom token (KAPU by default)."
    echo
    ...
    text_white "    lets you configure the directory where the Explorer is installed into when you do an KAPU Explorer installation (you can change this before you start the explorer installation)."
    echo
