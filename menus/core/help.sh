...
menu_manage_core_help ()
{
    ...
    text_yellow "    Update KAPU (U)"
    text_white "    update KAPU core if a new version is available."
    echo

    text_yellow "    Uninstall KAPU (P)"
    text_white "    uninstall KAPU Core from your system."
    echo

    text_yellow "    Configure KAPU (C)"
