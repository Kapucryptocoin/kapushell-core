...
commander_configure_repo ()
{
    ...
    if [[ -d "$CORE_DIR" ]]; then
        warning "KAPU Core will be pointed to ${CORE_REPO}. This will restart your node."
...
commander_configure_core_directory ()
{
    ...
    if [[ -d "$CORE_DIR" ]]; then
        warning "KAPU Core will be stopped and moved to ${CORE_DIR}. This will restart your node."
...
commander_configure_explorer_repo ()
{
    ...
    if [[ -d "$EXPLORER_DIR" ]]; then
        warning "KAPU Explorer will be pointed to ${EXPLORER_REPO}. This will restart your explorer."
...
commander_configure_explorer_directory ()
{
    ...
    if [[ -d "$EXPLORER_DIR" ]]; then
        warning "KAPU Explorer will be stopped and moved to ${EXPLORER_DIR}. This will restart your explorer."
